<?php
include "C:\wamp64\www\back1\config3.php";
session_start();
include 'C:\wamp64\www\back1\entities\Commande.php';
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Commandes</h2>
                            <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Reclamations et Commandes</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Afficher Les Commandes</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <!-- ============================================================== -->
                    ...
                    <thead>
                    <tr>
                        <th style="color: #1b1e21">Num commande</th>
                        <th style="color: #1b1e21">id panier</th>
                        <th style="color: #1b1e21">prix</th>
                        <th style="color: #1b1e21">date</th>
                    </tr>
                    </thead>
                    ...
                    ?>
                                <tr>
                                    ...
                                    <td><?php echo $rec->getIdpanier() ?></td>
                                    <td><?php echo $rec->getPrix() ?></td>
