         ...
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.html">
                  <img src="../assets/images/fazety.png" width="150" height="50"alt="CoolAdmin"></a></a>
                                  ...
                                  <div class="card-body p-0">
                                    <div class="table-responsive">
                                      ...
                                      <form action="modifierproduit.php " method="post">
                                        <tr>
                                          <td><input class="form-control" readonly type="text" name="ref_produit" id="ref_produit" value=" <?php echo $row['ref_produit']; ?>"></td>
                                          <td><input class="form-control" type="text" name="designation" id="designation" value=" <?php echo $row['designation']; ?>"></td>
                                          <td><input class="form-control" type="text" name="prix" id="prix" value="<?php echo $row['prix']; ?>"</td>
                                          <td><input class="form-control" type="text" name="quantite" id="quantite" value="<?php echo $row['quantite']; ?>"</td>

                                          <td> <input class="btn btn-sm btn-info float-left" type="submit" value="Modifier" > </td>
                                        </form>
                                        <form action="supprimerproduit.php " method="post">
                                          <input type="text" value="<?php echo $row['ref_produit'] ?>" hidden name="idsup">
                                          <td> <input class="btn btn-sm btn-info float-left" type="submit" value="supprimer" > </td>
                                        </form>
                                        ...
                                        <tbody>
                                          ...
                                          <form action="modifiercategorie.php " method="post">
                                            <tr>
                                              <td><input class="form-control" readonly type="text" name="id_categorie" id="id_categorie" value=" <?php echo $row['id_categorie']; ?>"></td>
                                              <td><input class="form-control" type="text" name="nom_categorie" id="nom_categorie" value=" <?php echo $row['nom_categorie']; ?>"></td>


                                              <td> <input class="btn btn-sm btn-info float-left" type="submit" value="Modifier" > </td>
                                            </form>
                                            <form action="supprimercategorie.php " method="post">
                                              <input type="text" value="<?php echo $row['id_categorie'] ?>" hidden name="idsup">
                                              <td> <input class="btn btn-sm btn-info float-left" type="submit" value="supprimer" > </td>
                                            </form>
