        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.html">  <img src="../assets/images/fazety.png" width="150" height="50"alt="CoolAdmin"></a>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Fidelite</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
...
<td> <input type="submit" name="submit" value="submit"> </td>
              ...
              <button> <a href="rechercher_ref.php" target="_blank">rechercher </a> </button>
                               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
