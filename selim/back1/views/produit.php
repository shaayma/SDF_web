            ...
            <div class="container-fluid  dashboard-content">
              ...
              <form method="POST" action="ajoutproduit.php">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="prix" placeholder="Enter price" name="prix" pattern='[0-9]+(\\.[0.9][0.9]?)?' required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Quantité:</label>
                    <input type="number" class="form-control" id="quantite" placeholder="enter quantity" name="quantite" min="1" max="30" required>
                  </div>
                  <div >
                    <label >Image:</label>
                    <div >
                        <input type="file" required name="image" href="C:\wamp64\www\back1\views\ach.PNG" >
                    </div>
                </div>
              ...
              <table class="table table-striped table-bordered first">
                  ...
                  <input type="text" class="form-control" id="id_categorie" placeholder="Enter id" name="id_categorie">
                  </div>
                  <div class="form-group">
                  <label for="exampleInputEmail1">nom categorie:</label>
                  <input type="text" class="form-control" id="nom_categorie" placeholder="Enter noun" name="nom_categorie">
                  </div>
                  <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Submit</button>
                  </div>
