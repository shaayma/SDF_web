        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets\img\product\fazety-removebg-preview.png" alt="">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3">
                                <div class="logo">
                                  <a href="index.html"><img src="assets\img\product\fazety-removebg-preview.png" width="150" height="50" alt=""></a>
                                </div>
                            </div>
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="Catagori.php">category</a></li>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="/back1/views/images/<?php echo $row['image']?>" alt="">
                                    ...
                                    <div class="product-caption">
                                        ...
                                        <h4><a href="#"><?php echo $row['designation']; ?></a></h4>
                                        <div class="price">
                                            <ul>
                                                <li><?php echo $row['prix']; ?></li>
                                                <li class="discount">60.00DT</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
